...
**login** | **str** | The user&#39;s login username, which must be unique within the system. For user accounts this should exactly match the user&#39;s email address. | 
**alternative_user_ids** | **Dict[str, Optional[str]]** |  | [optional] 
...
roles: Optional[List[RoleId]] = # Replace with your value
type: StrictStr = "example_type"
user_expiry: Optional[datetime] = # Replace with your value
create_user_request_instance = CreateUserRequest(first_name=first_name, last_name=last_name, email_address=email_address, second_email_address=second_email_address, login=login, alternative_user_ids=alternative_user_ids, roles=roles, type=type, user_expiry=user_expiry)
