...
[**get_user_from_login**](UsersApi.md#get_user_from_login) | **GET** /api/users/fromlogin/{login} | GetUserFromLogin: Get User From Login
...
# **get_user_from_login**
> UserResponse get_user_from_login(login)
...
def main():
    ...
    # Create an instance of the API class
    api_instance = api_client_factory.build(UsersApi)
    login = 'login_example' # str | The unique login for the User

    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_user_from_login(login, opts=opts)
        ...
        print("Exception when calling UsersApi->get_user_from_login: %s\n" % e)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **login** | **str**| The unique login for the User | 
