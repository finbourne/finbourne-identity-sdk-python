...
update_user_request_instance = UpdateUserRequest(first_name=first_name, last_name=last_name, email_address=email_address, second_email_address=second_email_address, login=login, alternative_user_ids=alternative_user_ids, roles=roles, user_expiry=user_expiry)
