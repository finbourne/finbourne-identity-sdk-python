...
class UsersApi:
    ...
    @overload
    async def get_user_from_login(self, login : Annotated[StrictStr, Field(..., description="The unique login for the User")], **kwargs) -> UserResponse:  # noqa: E501
        ...

    @overload
    def get_user_from_login(self, login : Annotated[StrictStr, Field(..., description="The unique login for the User")], async_req: Optional[bool]=True, **kwargs) -> UserResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_user_from_login(self, login : Annotated[StrictStr, Field(..., description="The unique login for the User")], async_req: Optional[bool]=None, **kwargs) -> Union[UserResponse, Awaitable[UserResponse]]:  # noqa: E501
        """GetUserFromLogin: Get User From Login  # noqa: E501

        Get the userId of a specified User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_user_from_login(login, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_user_from_login_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_user_from_login_with_http_info(login, **kwargs)  # noqa: E501

    @validate_arguments
    def get_user_from_login_with_http_info(self, login : Annotated[StrictStr, Field(..., description="The unique login for the User")], **kwargs) -> ApiResponse:  # noqa: E501
        """GetUserFromLogin: Get User From Login  # noqa: E501
        ...
        >>> thread = api.get_user_from_login_with_http_info(login, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_from_login" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
