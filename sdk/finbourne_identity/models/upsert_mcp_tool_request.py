...
class UpsertMcpToolRequest(BaseModel):
    ...
    __properties = ["name", "title", "description", "destructive", "idempotent", "openWorld", "readOnly", "parameters", "luminescePayload", "schedulerPayload", "destructiveActionSummaryTemplate"]
