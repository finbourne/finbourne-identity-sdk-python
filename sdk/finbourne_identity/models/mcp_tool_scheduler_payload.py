...
class McpToolSchedulerPayload(BaseModel):
    ...
    run_as:  Optional[StrictStr] = Field(None,alias="runAs", description="Optional service user identifier to run the job as (if not the current user)") 
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.run_as is None and "run_as" in self.__fields_set__:
            _dict['runAs'] = None
    ...
    def from_dict(cls, obj: dict) -> McpToolSchedulerPayload:
        ...
        if not isinstance(obj, dict):
            return McpToolSchedulerPayload.parse_obj(obj)

        _obj = McpToolSchedulerPayload.parse_obj({
...
McpToolSchedulerPayload.update_forward_refs()
