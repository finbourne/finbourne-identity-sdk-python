...
from finbourne_identity.api_client import ApiClient as AsyncApiClient
...
import finbourne_identity.extensions.retry as retry
from finbourne_identity.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_identity.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_identity if needed
