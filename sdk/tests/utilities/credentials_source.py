...
class CredentialsSource:
    ...
    def config_keys_path(cls) -> Path:
        return Path(__file__).parent.parent.parent.joinpath('finbourne_identity/utilities/config_keys.json')
    ...
    def fetch_credentials(cls):
        ...
        vars = {
            ...
            "api_url": os.getenv("FBN_LUSID_IDENTITY_URL", None)
        }
        ...
        if os.path.isfile(credentials):
            with open(credentials) as secrets_file:
                ...
                config_vars = {
                    ...
                    "api_url": secrets["api"].get("identityUrl", None),
                }
